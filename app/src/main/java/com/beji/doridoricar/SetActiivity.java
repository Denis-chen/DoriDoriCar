...
public class SetActiivity extends Activity {
    ...
    public class ConnectThread extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result.contains("good"))
                Toast.makeText(SetActiivity.this, "Connection Sucess!", Toast.LENGTH_LONG).show();
            else {
                Toast.makeText(SetActiivity.this, "Connection failed!", Toast.LENGTH_LONG).show();
            }
        }
    }
